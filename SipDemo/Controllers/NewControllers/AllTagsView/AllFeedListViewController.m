...
@interface AllFeedListViewController ()

@end

@implementation AllFeedListViewController

@synthesize arrFeedList,tagId,startDate,endDate;

@synthesize objStatusFeedDetailViewController,objFormFeedDetailViewController,objFeedDetailViewController,popoverView,popoverContent,popoverController,objRouteFeedDetailViewController,objRecieptFeedDetailViewController;
...
-(void)requestForGetTagFeeds
{
    if([ConfigManager isInternetAvailable]){
        ...
        [dic setObject:txtHashSearch.text forKey:@"has_tag"];
        
        
        [[AmityCareServices sharedService] AllTagPostInvocation:dic delegate:self];
    }
    else{
...
{
    [txtHashSearch resignFirstResponder];
    return TRUE;
}
