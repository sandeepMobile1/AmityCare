...
@interface SmileViewController : UIViewController <UITableViewDelegate,UITableViewDataSource,SmileFeedListInvocationDelegate,AllHappyFacePostsInvocationDelegate,DeleteSmileyInvocationDelegate>
{
