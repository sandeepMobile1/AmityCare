//
//  AllHappyFacePostViewController.m
//  Amity-Care
//
...
@interface AllHappyFacePostViewController ()

@end

@implementation AllHappyFacePostViewController

@synthesize tagId,arrFeedList,objFeedDetailViewController,objFormFeedDetailViewController,objStatusFeedDetailViewController,popoverController,objRouteFeedDetailViewController,objRecieptFeedDetailViewController;
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    feedCell = (FavoriteTableViewCell*)[tblView dequeueReusableCellWithIdentifier:feedCellIdentifier];
