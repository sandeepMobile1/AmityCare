//
//  StatusFeedDetailViewController.m
//  Amity-Care
//
...
@interface StatusFeedDetailViewController ()

@end

@implementation StatusFeedDetailViewController

@synthesize feedDetails,checkBSAndFamily,locationVC;
...
-(void)setFrame
{
    ...
    if (IS_DEVICE_IPAD) {
        ...
        //sizeToFit= [self.feedDetails.postDesc sizeWithFont:[UIFont fontWithName:appfontName size:descfontsize] constrainedToSize:CGSizeMake(410.0f, CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
        
        CGRect textRect = [self.feedDetails.postDesc boundingRectWithSize:CGSizeMake(410.0f, CGFLOAT_MAX)
    ...
    int y=CGRectGetMaxY(txtDesc.frame)+10;
