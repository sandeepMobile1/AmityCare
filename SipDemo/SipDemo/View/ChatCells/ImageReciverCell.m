...
@implementation ImageReciverCell
...
{
    if ([self.cellDelegate respondsToSelector:@selector(ChatRecieverImageButtonClick:)])
    {
        [self.cellDelegate ChatRecieverImageButtonClick:self];
    }
}
