...
- (void)drawRect:(CGRect)rect
{
   ...
   // [weekdays moveObjectFromIndex:6 toIndex:0];
    ...
    if (self.selectedDate!=nil) {
        ...
        // selectedDateBlock= ([selectedDate day]-1)+firstWeekDay;
...
//        NSLog(@"currentMonth %@",currentMonth);
        ...
        [date drawInRect:CGRectMake(targetX+2, targetY+20, kVRGCalendarViewDayWidth, kVRGCalendarViewDayHeight) withFont:[UIFont fontWithName:@"HelveticaNeue-Bold" size:21] lineBreakMode:NSLineBreakByClipping alignment:NSTextAlignmentCenter];
    }
...
//                                       [UIColor colorWithHexString:@"0x383838"].CGColor);
        ...
        CGRect rectangle1 = CGRectMake(targetX+28,targetY+46,5,5);
        ...
        [date drawInRect:CGRectMake(targetX, targetY+20, kVRGCalendarViewDayWidth, kVRGCalendarViewDayHeight) withFont:[UIFont fontWithName:@"HelveticaNeue-Bold" size:20] lineBreakMode:NSLineBreakByClipping alignment:NSTextAlignmentCenter];
